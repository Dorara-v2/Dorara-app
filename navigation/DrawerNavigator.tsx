...
export default function DrawerNavigator() {
  ...
  return (
    <Drawer.Navigator
      ...
      <Drawer.Screen
        name="Todo"
        component={TaskTodoNavigation}
        options={{
          drawerIcon: ({ color }) => <MaterialIcon name="checklist" size={30} color={color} />,
        }}
      />
      <Drawer.Screen
        name="Notes"
        ...
        options={{
          drawerIcon: ({ color }) => <MaterialIcon name="notes" size={30} color={color} />,
        }}
      />
      <Drawer.Screen
        name="Bookmarks"
        component={HomeScreen}
        options={{
          drawerIcon: ({ color }) => <MaterialIcon name="bookmark" size={30} color={color} />,
        }}
      />
      <Drawer.Screen
        name="Routines"
        component={HomeScreen}
        options={{
          drawerIcon: ({ color }) => <MaterialIcon name="schedule" size={30} color={color} />,
        }}
      />
      <Drawer.Screen
        name="Expense"
        component={HomeScreen}
        options={{
          drawerIcon: ({ color }) => <MaterialIcon name="currency-rupee" size={30} color={color} />,
        }}
      />
    </Drawer.Navigator>
  );
